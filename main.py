...
def home(): 
    ...
    st = random.choice(["SISTEMA OK", "SISTEMA OK", "ALERTA: SENAL DEBIL"]) 
...
def home(): 
    ...
    if request.method == 'POST': 
        ...
        resp = f"Como experto en NOVA, te confirmo que procesamos {c:.1f} ppm de carbono. ¨Deseas analizar el hardware?" 
